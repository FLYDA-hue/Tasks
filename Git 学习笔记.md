...
![设置用户名和邮箱地址](D:\fly的文件\QQ20251107-235052.png)
...
![创建空目录](D:\fly的文件\QQ20251107-235946.png)

###### （注意确保目录名不包含中文，避免不必要的麻烦）

##### 在当前目录下创造一个新的Git仓库。

![创造git仓库](D:\fly的文件\QQ20251108-000356.png)
...
![远程仓库添加](D:\fly的文件\QQ20251108-000853.png)
...
![示意图](D:\fly的文件\QQ20251108-002503.png)
